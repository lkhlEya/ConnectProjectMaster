   ...
   @FXML
    ...
    private void refreshTable() {
        try {
            ...
            query = "SELECT * FROM Internship WHERE type='recommendation' AND supervisor!= 'done'";
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        EyeIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            readonlycontroller.ReadTextField(reclamation.getREF(), "recommendation",reclamation.getCompany(), reclamation.getField(), reclamation.getTitle(), reclamation.getDescription(), reclamation.getSupervisor(), reclamation.getStatus());   
                        ...
                        editIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            repondrecontroller.setUpdate(true);
                            repondrecontroller.setTextField(reclamation.getREF(), "opinion",reclamation.getCompany(), reclamation.getField(), reclamation.getTitle(), reclamation.getDescription(), reclamation.getStatus());   
                            Parent parent = loader.getRoot();
                            Stage stage = new Stage();
                            stage.setScene(new Scene(parent));
                            stage.initStyle(StageStyle.UTILITY);
